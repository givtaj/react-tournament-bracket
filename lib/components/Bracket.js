...
var toBracketGames = function (_a) {
    ...
    return [
        ...
        return [
            React.createElement("path", { key: game.id + "-" + side + "-" + y + "-path", d: pathInfo.join(' '), fill: 'transparent', stroke: 'black', className: 'svg-test' })
...
var Bracket = /** @class */ (function (_super) {
    ...
    Bracket.prototype.render = function () {
        ...
        var svgDimensions = {
            ...
            width: numRounds * (gameDimensions.width + roundSeparatorWidth) +
                svgPadding * 2
        };
